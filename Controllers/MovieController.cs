...
namespace WebApplication17.Controllers
{
    ...
    public class MovieController : ApiController
    {
        ...
        [HttpGet]
        [Route("api/Movie/Movies")]
        public List<UI_data> GetMovies()
        {
            List<UI_data> listOfMovies = new List<UI_data>();
            ...
            for (int i = 0; i < totalNoOfMovies.Count; i++)
            {
                ...
                int id = totalNoOfMovies[i].MID;
                var Actors = db.Actors_Movie.Where(x => x.MID==id).ToList();
                ...
                listOfMovies.Add(new UI_data(movieName, releaseDate, producer, actors,id));
            }
            return listOfMovies;
        ...
        public bool InsertMovie(UI_data newMovie)
        {
            try
            {
